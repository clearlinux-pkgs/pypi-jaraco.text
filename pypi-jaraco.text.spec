...
Provides: jaraco.text
Provides: jaraco.text-python
Provides: jaraco.text-python3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641447621
...
cp %{_builddir}/jaraco.text-3.6.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-jaraco.text/8e6689d37f82d5617b7f7f7232c94024d41066d1
